    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .sessionManagement(session ->
                ...
                .requestMatchers(HttpMethod.PATCH,  "/api/resources/*/status").hasAnyRole("ADMIN", "TECHNICIAN")
                ...
                .requestMatchers(HttpMethod.PUT,    "/api/bookings/*/review").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,    "/api/bookings/stats").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET,    "/api/bookings/peak-hours").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET,    "/api/tickets/resource-types").authenticated()
                .requestMatchers(HttpMethod.GET,    "/api/tickets/floors").authenticated()
                .requestMatchers(HttpMethod.GET,    "/api/tickets/resources").authenticated()
                .requestMatchers(HttpMethod.GET,    "/api/tickets/technicians").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.POST,   "/api/tickets/*/accept").hasRole("TECHNICIAN")
